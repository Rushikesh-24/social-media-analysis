  ...
  return (
    <div className={`w-full min-h-screen overflow-hidden font-ubuntu-condensed relative `}>
      ...
      <header className="fixed top-0 w-full z-50 " id="Header">
            <div className="flex justify-between items-center py-6 px-20 max-w-8xl mx-auto">
      ...
      <div className="relative/ z-20 bg-black py-32 pt-20 px-6 w-full sticky top-0">
      ...
      <footer className="bg-black text-white py-16 relative z-20">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-xl font-bold">Hype.io</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="view">contact@hype.io</li>
              <li className="view">+1 (555) 123-4567</li>
              <li className="view">123 Hype Street, IN</li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400">
          <p>© 2025 Hype.io. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
